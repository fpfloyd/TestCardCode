...
def assay(theRig):
        ...
        #
        # #Empty Chamber
        # print 'Emptying Chamber with',WashoutVol*2,'uL @',WashoutRate,'uL/min , press ctrl+c to quit'
        # theRig.ValveOpen("V2")
        # time.sleep(0.5)
        # theRig.ValveClose("V1")
        # time.sleep(0.5)
        # theRig.PumpStart("B2", WashoutRate, WashoutVol)
        # time.sleep(WashoutTime+20)
        # theRig.PumpStart("B2", WashoutRate, WashoutVol)
        ...
        #RUN ASV
        theRig.RunASV()
        theRig.SaveASV(filename,filepath)
...
def main():
        ...
        theRig=TestCardRig("COM32","COM36","COM29","COM37") # valve controller, Magnet Controller, Vibration Controller, ASV
