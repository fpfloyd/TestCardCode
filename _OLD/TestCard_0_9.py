...
ASVPrimeTime=(ASVPrimeVol*60/ASVPrimeRate)+ExtraTime
PlasmaPushTime=(PlasmaPushVol*60/PlasmaPushRate)+ExtraTime
MagFlowTime=(MagFlowVol*60/MagFlowRate)+ExtraTime
WashoutTime=(WashoutVol*60/WashoutRate)+ExtraTime
WashTime=(WashVol*60/WashRate)+ExtraTime
SilverTime=(SilverVol*60/SilverRate)+ExtraTime
SandwichTime=(SandwichVol*60/SandwichRate)+ExtraTime
MoveTime=(MoveVol*60/MoveRate)+ExtraTime
ElecTime=(ElecVol*60/ElecRate)+ExtraTime
B1PrimeTime=(B1PrimeVol*60/PrimeRate)+ExtraTime
B2PrimeTime=(B2PrimeVol*60/PrimeRate)+ExtraTime
B3PrimeTime=(B3PrimeVol*60/PrimeRate)+ExtraTime
B4PrimeTime=(B4PrimeVol*60/PrimeRate)+ExtraTime
B5PrimeTime=(B5PrimeVol*60/PrimeRate)+ExtraTime
...
def main():
        ...
        theRig=TestCardRig("COM32","COM36") # valve controller, Magnet Controller
